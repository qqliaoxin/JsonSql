...
type JsonSqlExecutor struct {
	...
	TableSql       map[string]*GetMysqlExecutor    `json:"tableSql"`       //查询内数据集
	TableInsSql    map[string]*InsterMysqlExecutor `json:"tableInsSql"`    //插入数据集
	TableUpdateSql map[string]*UpdateMysqlExecutor `json:"tableUpdateSql"` //更新数据集
	TableDeleteSql map[string]*DeleteMysqlExecutor `json:"tableDeleteSql"` //删除数据集
